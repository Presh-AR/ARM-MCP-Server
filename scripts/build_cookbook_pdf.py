...
def cover_story() -> list[object]:
    ...
    return [
        ...
        Spacer(1, 0.15 * inch),
        Paragraph(
            "Based on the NVIDIA July 2026 QBR examples: automated PR validation, ARM CI checks, and daily deployment reporting. Built from the verified ARM MCP server contract.",
            STYLES["small"],
        ),
